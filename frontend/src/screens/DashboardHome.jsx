                            ...
                            >
                              <div className="list-col-name">
                                <div className="list-icon" style={{ color: file.color }}>
                                  ...
                                  {file.type === 'audio' && <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M3 18v-6a9 9 0 0 1 18 0v6"></path><path d="M21 19a2 2 0 0 1-2 2h1v-3a2 2 0 0 1 2-2h1zM3 19a2 2 0 0 0 2 2h1v-3a2 2 0 0 0-2-2H3z"></path></svg>}
                                </div>
                                <span>{file.name}</span>
                              </div>
